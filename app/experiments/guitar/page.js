            ...
            <div className="flex flex-col items-start max-w-full w-[895px]">
                ...
                <div className="flex flex-col max-w-full">
                    ...
                    <p className="mt-4 text-xl text-zinc-600">
                        Welcome to the Guitar experiment page!
                    </p>
                ...
                <div className="flex flex-col mt-36 max-w-full text-lg text-neutral-900 max-md:mt-10 mb-20">
                    ...
                    <div className="flex flex-col mt-3.5 w-full max-md:max-w-full mb-8">
                        <div className="max-md:max-w-full">
                            <span className="text-3xl font-bold text-neutral-900">
                                What is the Guitar Experiment?
                            </span>
                        </div>

                        <div className="mt-3 max-md:max-w-full">
                            The Guitar Experiment explores the intersection of music and
                            technology, showcasing innovative ways to interact with musical
                            instruments.
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col mt-3.5 w-full max-md:max-w-full mb-8">
                        ...
                        <div className="mt-3 max-md:max-w-full">
                            This experiment highlights unique features such as real-time
                            sound manipulation, interactive visuals, and more.
                        </div>
                    </div>
                </div>
            </div>
