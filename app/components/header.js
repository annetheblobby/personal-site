...
export default function Header({ experimentMode = false }) {
  return (
    <div
      className={`flex gap-5 justify-between w-full whitespace-nowrap text-neutral-500 max-md:flex-wrap max-md:max-w-full py-4 sticky top-0 z-50 ${experimentMode ? `bg-none` : `bg-[#FBF7F7]`
        } w-[895px]`}
    >
      <Link href="/">
        <Logo />
